		...
		<div class="container">
			...
			<form class="form-horizontal" method="POST" action="update.php" enctype="multipart/form-data" autocomplete="off">
				<div class="form-group">
					<label for="ID cliente" class="col-sm-2 control-label">ID cliente</label>
					<div class="col-sm-10">
						<input  id="id" name="id" value="<?php echo $row['id']; ?>" />
					</div>
				</div>
				<div class="form-group">
							...
							if(file_exists($path)){
								...
								while ($archivo = readdir($directorio))
								{
									if (!is_dir($archivo)){
										...
										echo "<img src='../formulario/files/$id/$archivo' width='300' />";
									}
								}
							}
