...
<html lang="en"><!-- InstanceBegin template="/Templates/contenido.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <meta name="description" content="Servicios a Domicilio de mecanica, electromecanica, hojalateria, detalling, tintes, piezas, camiones y mucho mas.">
...
<!-- InstanceBeginEditable name="titulo" -->
 <div id="titulo"><h1><strong>Servicios a Domicilio</strong></h1></div><!--titulo-->
  <div id="titulo"><h2><strong>Servicios a Domicilio de mecanica, electromecanica, hojalateria, detalling, tintes, piezas, camiones y mucho mas.</strong></h2></div><!--titulo-->
<!-- InstanceEndEditable -->
 </div>
...
<?php
			$db = $cnx_slider;
			try{	
					$sql = $sql = "SELECT DISTINCT * FROM clientes WHERE (estatus= 'si') AND (serv_dom =  'si') ORDER BY pago='no' ASC";
