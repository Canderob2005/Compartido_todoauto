...
<html lang="en"><!-- InstanceBegin template="/Templates/contenido.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
   ...
   <title>Autos Usados</title>
    ...
    <meta name="description" content="Autos usados, Toyota, Nissan, Kia, Hunday, Mazda, ford, chevrolet, Susuki, lexus, jeep, fiat, volswaguen, volvo, bmw, audi, alfa romeo, mini, cuper y mucho mas">
  <meta name="keywords" content=" Autos usados en Puerto rico,telefono, dirección">
<!-- InstanceEndEditable -->
...
<!-- InstanceBeginEditable name="titulo" -->
  <div id="titulo"><h1><strong>Dealers de Autos Usados</strong></h1></div><!--titulo-->
  <div id="titulo"><h2><strong>Venta autos usados en Puerto rico, Toyota, Nissan, Kia, Hunday, Mazda, ford, chevrolet, Susuki, lexus, jeep, fiat, volswaguen, volvo, bmw, audi, alfa romeo, mini, cuper y mucho mas</strong></h2></div><!--titulo-->
<!-- InstanceEndEditable -->
 </div>
...
<?php
			$db = $cnx_slider;
			try{	
					$sql = $sql = "SELECT DISTINCT * FROM clientes WHERE (estatus= 'si') AND (id_serv =  'Dealers Autos Usados') ORDER BY pago='no' ASC";
