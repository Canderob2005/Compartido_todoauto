...
<html lang="en"><!-- InstanceBegin template="/Templates/contenido.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <!-- InstanceBeginEditable name="doctitle" -->
     <title>Dealers Camiones / Venta Camiones</title>
    <!-- InstanceEndEditable -->
    <!-- InstanceBeginEditable name="head" -->
<meta name="description" content="Dealers de Camiones, ford, chevrolet,mercedes benz,Dodge y mucho mas.">
  <meta name="keywords" content=" Venta Camiones,telefono, direccion"> 
<!-- InstanceEndEditable -->
...
<!-- InstanceBeginEditable name="titulo" -->
 <div id="titulo"><h1><strong>Dealers de Camiones / Venta Camiones</strong></h1></div><!--titulo-->
  <div id="titulo"><h2><strong>Venta Camiones Nuevos y Usados, ford, chevrolet,mercedes benz,Dodge y mucho mas.</strong></h2></div><!--titulo-->
<!-- InstanceEndEditable -->
 </div>
...
<?php
			$db = $cnx_slider;
			try{	
					$sql = $sql =  "SELECT DISTINCT * FROM clientes WHERE (estatus= 'si') AND (id_serv =  'Dealer Camiones') ORDER BY pago='no' ASC";
