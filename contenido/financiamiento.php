...
<html lang="en"><!-- InstanceBegin template="/Templates/contenido.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <title>Financiamiento Auto, vans, Camiones, motoras </title>
    <!-- InstanceEndEditable -->
    <!-- InstanceBeginEditable name="head" -->

    <meta name="description" content="Servicios financiamiento para Autos,Camiones, motoras, vans">
  <meta name="keywords" content="Financiamiento para Autos,Camiones, motoras, vans, direccion"> 
<!-- InstanceEndEditable -->
...
<!-- InstanceBeginEditable name="titulo" -->
  <div id="titulo"><h1><strong>Financiamiento</strong></h1></div><!--titulo-->
  <div id="titulo"><h2><strong>Financiamiento Auto, vans, Camiones, motoras mucho mas.</strong></h2></div><!--titulo-->
<!-- InstanceEndEditable -->
 </div>
...
<?php
			$db = $cnx_slider;
			try{	
					$sql = $sql = "SELECT DISTINCT * FROM clientes WHERE (estatus= 'si') AND (id_serv =  'Financiamiento Autos') ORDER BY pago='no' ASC";
