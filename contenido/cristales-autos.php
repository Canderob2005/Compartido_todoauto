...
<html lang="en"><!-- InstanceBegin template="/Templates/contenido.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
   ...
   <title>Venta, instalación cristales autos</title>
    <!-- InstanceEndEditable -->
    <!-- InstanceBeginEditable name="head" -->
 
    <meta name="description" content="Servicios, venta, instalación de Cristales para Autos, Camiones,Vans">
  <meta name="keywords" content="Servicios, venta, instalación de Cristales para Autos, telefono, direccion, taller, especialidad"> 
<!-- InstanceEndEditable -->
...
<!-- InstanceBeginEditable name="titulo" -->
 <div id="titulo"><h1><strong>Venta e instalación de cristales para autos</strong></h1></div><!--titulo-->
  <div id="titulo"><h2><strong>Servicios, venta, instalación de cristales para autos y camiones</strong></h2></div><!--titulo-->
<!-- InstanceEndEditable -->
 </div>
...
<?php
			$db = $cnx_slider;
			try{	
					$sql = $sql = "SELECT DISTINCT * FROM clientes WHERE (estatus= 'si') AND (id_serv =  'Cristales autos') ORDER BY pago='no' ASC";
