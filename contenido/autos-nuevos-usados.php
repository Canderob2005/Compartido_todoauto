...
<html lang="en"><!-- InstanceBegin template="/Templates/contenido.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <title>Ventas Autos Nuevos y Usados</title>
    <!-- InstanceEndEditable -->
    <!-- InstanceBeginEditable name="head" -->
<meta name="description" content="Ventas autos nuevos y usados en Puerto rico">
 <meta name="keywords" content=" Dealers  autos nuevos y usados, telefono, direccion"> 
<!-- InstanceEndEditable -->
...
<!-- InstanceBeginEditable name="titulo" -->
 <div id="titulo"><h1><strong>Dealers de Autos Nuevos y Usados.</strong></h1></div><!--titulo-->
  <div id="titulo"><h2><strong>Ventas Autos Nuevos y Usados en Puerto Rico.</strong></h2></div><!--titulo-->
<!-- InstanceEndEditable -->
 </div>
...
<?php
			$db = $cnx_slider;
			try{	
					$sql = $sql = "SELECT DISTINCT * FROM clientes WHERE (estatus= 'si') AND (id_serv =  '') ORDER BY pago='no' ASC";
