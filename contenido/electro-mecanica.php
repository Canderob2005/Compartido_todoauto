...
<html lang="en"><!-- InstanceBegin template="/Templates/contenido.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <title>Electromecanico</title>
    <!-- InstanceEndEditable -->
    <!-- InstanceBeginEditable name="head" -->

    <meta name="description" content="Reparación de sistemas electricos para Autos y camiones y mucho mas">
  <meta name="keywords" content="Reparación de sistemas electricos para Autos y camiones, telefono, direccion, taller, especialidad">
<!-- InstanceEndEditable -->
...
<!-- InstanceBeginEditable name="titulo" -->
  <div id="titulo"><h1><strong>Reparación Sistemas Electricos Para Autos</strong></h1></div><!--titulo-->
  <div id="titulo"><h2><strong>Reparación de sistemas electricos para Autos y camiones, guaguas y mucho mas.</strong></h2></div><!--titulo-->
<!-- InstanceEndEditable -->
 </div>
...
<?php
			$db = $cnx_slider;
			try{	
					$sql = $sql = "SELECT DISTINCT * FROM clientes WHERE (estatus= 'si') AND (id_serv =  'Electromecanico') ORDER BY pago='no' ASC";
