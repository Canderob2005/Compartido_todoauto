...
<html lang="en"><!-- InstanceBegin template="/Templates/contenido.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
   ...
   <title>Venta y Reparación de Radiadores</title>
    <!-- InstanceEndEditable -->
    <!-- InstanceBeginEditable name="head" -->

    <meta name="description" content="Venta y Reparación de Radiadores para Autos y camiones y mucho mas.">
  <meta name="keywords" content="Guia automotriz, Busqueda taller de radiadores, telefono, direccion, taller, especialidad">
<!-- InstanceEndEditable -->
...
<!-- InstanceBeginEditable name="titulo" -->
  <div id="titulo"><h1><strong>Venta y Reparación de Radiadores</strong></h1></div><!--titulo-->
  <div id="titulo"><h2><strong>Venta y Reparación de Radiadores para Autos y camiones y mucho mas.</strong></h2></div><!--titulo-->
<!-- InstanceEndEditable -->
 </div>
...
<?php
			$db = $cnx_slider;
			try{	
					$sql = $sql = "SELECT DISTINCT * FROM clientes WHERE (estatus= 'si') AND (id_serv =  'Radiadores') ORDER BY pago='no' ASC";
