...
<html lang="en"><!-- InstanceBegin template="/Templates/contenido.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
   ...
   <title>Cotización de seguro Computarizado</title>
    <!-- InstanceEndEditable -->
    <!-- InstanceBeginEditable name="head" -->

    <meta name="description" content="Cotización seguro Computarizado para Autos, Camiones, Autos nuevos, Autos usados">
  <meta name="keywords" content=" Cotización seguro Computarizado para Autos, telefono, direccion"
<!-- InstanceEndEditable -->
...
<br>
  <div id="titulo"><h1><strong>Estimados de carros chocados / Estimados para seguro de accidente de autos computarizado</strong></h1></div><!--titulo-->
  <div id="titulo"><h2><strong>Cotización de seguro computarizado para choque de autos y mucho mas</strong></h2></div><!--titulo-->
<!-- InstanceEndEditable -->
 </div>
...
<?php
			$db = $cnx_slider;
			try{	
					$sql = $sql = "SELECT DISTINCT * FROM clientes WHERE (estatus= 'si') AND (id_serv =  'Cotización seguro') ORDER BY pago='no' ASC";
