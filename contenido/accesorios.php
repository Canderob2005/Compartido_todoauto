...
if ($cnx_slider -> connect_errno) {
  echo "Failed to connect to MySQL: " .$cnx_slider -> connect_error;
  exit();
}
?>
<!--& nbsp; ---->
...
<html lang="en"><!-- InstanceBegin template="/Templates/contenido.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <title>Los mejores precios en Accesorios para autos, camiones, motoras, interior y exterior los encuentras aqui</title>
    <!-- InstanceEndEditable -->
    <!-- InstanceBeginEditable name="head" -->
<meta name="description" content="Accesorios para autos, camiones, motoras, interior y exterior ">
 <meta name="keywords" content="Accesorios, bocinas, radio,luces,focos, reflectores, aplificador, alarma"> 
<!-- InstanceEndEditable -->
...
<!-- InstanceBeginEditable name="titulo" -->
 ...
 <div id="titulo"><h1><strong>Los mejores precios en Accesorios para autos, camiones, motoras, interior y exterior los encuentras aqui....</strong></h1></div><!--titulo-->
  <div id="titulo"><h2><strong>Encuentra las mejores tiendas en Puerto rico en venta, servicio e instalación de accesorios, alarma, bocina, radios y mucho mas.</strong></h2></div><!--titulo-->
...
<?php
			$db = $cnx_slider;
			try{	
					$sql = $sql = "SELECT DISTINCT * FROM clientes WHERE (estatus= 'si') AND (id_serv =  'Accesorios para autos, camiones, motoras') ORDER BY pago='no' ASC";
...
<div id="contenido2">&nbsp;</div>
 ...
 <!-- InstanceBeginEditable name="marquee" -->
   <div id="anuncio-footer"><MARQUEE WIDTH=100%  ALIGN=MIDDLE ><h5>Venta instalación, Accesorios para autos, camiones, motoras, luces, alarmas,  y mucho mas.....</h5></MARQUEE></div>
   <!-- InstanceEndEditable -->
 <!-- Footer -->
	<section  id="footer">
