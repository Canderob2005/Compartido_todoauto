...
<html lang="en"><!-- InstanceBegin template="/Templates/contenido.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <title>Venta y Reparación de Gomas</title>
    <!-- InstanceEndEditable -->
    <!-- InstanceBeginEditable name="head" -->
 
    <meta name="description" content="Taller de Reparación de gomas para Autos y camiones y mucho mas.">
  <meta name="keywords" content="Taller de Reparación de gomas para Autos y camiones, telefono, direccion, taller">
<!-- InstanceEndEditable -->
...
<!-- InstanceBeginEditable name="titulo" -->
 <div id="titulo"><h1><strong>Venta y Reparación de Gomas </strong></h1></div><!--titulo-->
  <div id="titulo"><h2><strong>Reparación de gomas para Autos y camiones y mucho mas.</strong></h2></div><!--titulo-->
<!-- InstanceEndEditable -->
 </div>
...
<?php
			$db = $cnx_slider;
			try{	
					$sql = $sql = "SELECT DISTINCT * FROM clientes WHERE (estatus= 'si') AND (id_serv =  'Gomeras') ORDER BY pago='no' ASC";
