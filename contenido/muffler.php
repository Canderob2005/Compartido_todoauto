...
<html lang="en"><!-- InstanceBegin template="/Templates/contenido.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
   ...
   <title>Venta y Reparación de Muffler</title>
    <!-- InstanceEndEditable -->
    <!-- InstanceBeginEditable name="head" -->

    <meta name="description" content="Reparación de Muffler para Autos y camiones y mucho mas.">
  <meta name="keywords" content="Guia automotriz, Busqueda servicios de Reparación de Muffler para Autos y camiones, telefono, direccion, taller">
<!-- InstanceEndEditable -->
...
<!-- InstanceBeginEditable name="titulo" -->
  <div id="titulo"><h1><strong>Venta y Reparación de Muffler</strong></h1></div><!--titulo-->
  <div id="titulo"><h2><strong>Reparación de Muffler para Autos y camiones, van, guaguas pasajeros y mucho mas.</strong></h2></div><!--titulo-->
<!-- InstanceEndEditable -->
 </div>
...
<?php
			$db = $cnx_slider;
			try{	
					$sql = $sql = "SELECT DISTINCT * FROM clientes WHERE (estatus= 'si') AND (id_serv =  'Mufflers') ORDER BY pago='no' ASC";
