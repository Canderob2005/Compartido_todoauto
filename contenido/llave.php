...
<html lang="en"><!-- InstanceBegin template="/Templates/contenido.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <title>Cerrajeria / Copias Llaves</title>
    <!-- InstanceEndEditable -->
    <!-- InstanceBeginEditable name="head" -->

    <meta name="description" content="Cerrajeria y Copias de llaves para Autos y camiones y mucho mas.">
  <meta name="keywords" content="Cerrajeria  para Autos y camiones, telefono, direccion, taller, especialidad">
<!-- InstanceEndEditable -->
...
<!-- InstanceBeginEditable name="titulo" -->
  <div id="titulo"><h1><strong>Servicio de Cerrajeria  Autos</strong></h1></div><!--titulo-->
  <div id="titulo"><h2><strong>Copia de llave para Autos y camiones y mucho mas.</strong></h2></div><!--titulo-->
<!-- InstanceEndEditable -->
 </div>
...
<?php
			$db = $cnx_slider;
			try{	
					$sql = $sql = "SELECT DISTINCT * FROM clientes WHERE (estatus= 'si') AND (id_serv =  'Copia de Llave, cerrajeria') ORDER BY pago='no' ASC";
