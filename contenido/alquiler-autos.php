...
<html lang="en"><!-- InstanceBegin template="/Templates/contenido.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <title>Alquier de autos, vans de carga, vans de pasajero, camiones de carga, camiones refrigerados</title>
    <!-- InstanceEndEditable -->
    <!-- InstanceBeginEditable name="head" -->

    <meta name="description" content="Alquielr de autos, vans de carga, vans de pasajero, camiones de carga, camiones refrigerados">
  <meta name="keywords" content="Aquiler Autos, Aquiler Camiones, Aquiler Autos nuevos,telefono, direccion"> 
<!-- InstanceEndEditable -->
...
<!-- InstanceBeginEditable name="titulo" -->
 ...
 <div id="titulo"><h1><strong>Alquiler autos, vans de carga, vans de pasajero, camiones de carga, camiones refrigerados</strong></h1></div><!--titulo-->
  <div id="titulo"><h2><strong>Los mejores precios y servicios en alquiler de autos, vans de carga, vans de pasajero, camiones de carga, camiones refrigerados y mucho mas....</strong></h2></div><!--titulo-->
<!-- InstanceEndEditable -->
 </div>
...
<?php
			$db = $cnx_slider;
			try{	
					$sql = $sql = "SELECT DISTINCT * FROM clientes WHERE (estatus= 'si') AND (id_serv =  'Alquiler Autos, Camiones, Vans') ORDER BY pago='no' ASC"; 
...
<!-- InstanceBeginEditable name="contenido" -->
 ...
 <!-- InstanceBeginEditable name="marquee" -->
   <div id="anuncio-footer"><MARQUEE WIDTH=100%  ALIGN=MIDDLE ><h5>Alquier de autos, vans de carga, vans de pasajero, camiones de carga, camiones refrigerados y mucho mas.....</h5></MARQUEE></div>
   <!-- InstanceEndEditable -->
 <!-- Footer -->
	<section  id="footer">
