...
<!--& nbsp; ---->
<!doctype html>
<html lang="en"><!-- InstanceBegin template="/Templates/contenido.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no" >
    <!-- InstanceBeginEditable name="doctitle" -->
     <title>Gestoria, licencia, marbete, multas, traspaso de vehiculos de motor, Abogado, Medico, declaración jurada</title>

    <!-- InstanceEndEditable -->
    <!-- InstanceBeginEditable name="head" -->
<meta name="description" content="Gestoria, traspaso licencia vehiculo, traspaso licencia auto, traspaso licencia motoras , marbete, multas, traspaso licencia vehiculos de motor, cambio tablilla, fotos 2x2, examen medico, comprobantes, comprobante de rentas internas, Abogado, Medico, declaración jurada">
 <meta name="keywords" content="Gestoria, licencia, marbete, multas, traspaso, Guia automotriz, Busqueda de centro de servicios DTOP, telefono, direccion">
<!-- InstanceEndEditable -->
...
<script src="../js/ddba1ed91f.js"></script> 
...
<div id="titulo"><h1><strong>Gestoria, licencia, marbete, multas, traspaso de vehiculos de motor, Abogado, Medico, declaración jurada</strong></h1></div><!--titulo-->

  <div id="titulo"><h2><strong> obtener servicio / información sobre multas / sellos /  documentos necesarios para licencia / marbete / pago de multas auto expreso / traspaso de vehiculos de motor</strong></h2></div><!--titulo-->
...
<?php
$cnx_slider = new mysqli('localhost','u317430902_canderob','Camara123*','u317430902_todoautopr');
...
?>
<!-- InstanceBeginEditable name="cards" -->
...
<div class="card-body">
 ...
 <a href="servicios/<?php echo  $record['info']; ?>"> 
<img  style="margin-top:5%;" src="../card/img-menu-contenido/<?php echo $record['image']; ?> ">
</div>
<div class="card-body info">
<h5 class="card-title" style="color:#0B0B61;"><?php echo $record['servicio']; ?></h5>
...
<table id="informacion"   style="text-align:center;width:100%; min-width:100%;" >
	<thead>
	  ...
	  <th style="width:33%;"><h1><strong>Información</strong></h1></th>
...
<?php
			$db = $cnx_slider;
			try{	
					$sql = $sql = "SELECT DISTINCT * FROM clientes WHERE (estatus= 'si') AND (id_serv =  'Gestoria') ORDER BY pago='no' ASC";
...
#subtitulo a {
 ...
 <div id="contenido2">
 <div id="subtitulo"><h2><strong>Link para obtener información sobre multas, sellos y  documentos necesarios para licencia, marbete, pago de multas auto expreso, traspaso de vehiculos de motor</strong></h2></div><!--titulo-->
 <div id="subtitulo"><h2><strong> <a href="https://www.dtop.pr.gov/" title="DTOP" target="_blank">Dtop</a>   <a href="http://www.hacienda.pr.gov/pagos/sistema-electronico-para-imprimir-y-o-vender-sellos-y-comprobantes" title="Departamento hacienda" target="_blank">Departamento hacienda</a>  <a href="https://www.autoexpreso.com/home" title="Auto expreso" target="_blank">Auto expreso</a></strong></h2></div><!--titulo--></div>
 <!-- InstanceEndEditable -->
