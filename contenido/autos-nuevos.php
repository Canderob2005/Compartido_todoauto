...
<html lang="en"><!-- InstanceBegin template="/Templates/contenido.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
   ...
   <title>Venta Autos Nuevos, Toyota, Nissan, Kia, Hunday, Mazda, ford, chevrolet, Susuki, lexus, jeep, fiat, volswaguen, volvo, bmw, audi, alfa romeo, mini, cuper</title>
    <!-- InstanceEndEditable -->
    <!-- InstanceBeginEditable name="head" -->
<meta name="description" content="Venta Autos Nuevos, Toyota, Nissan, Kia, Hunday, Mazda, ford, chevrolet, Susuki, lexus, jeep, fiat, volswaguen, volvo, bmw, audi, alfa romeo, mini, cuper y mucho mas.">
  <meta name="keywords" content=" Dealers autos nuevos,telefono">
<!-- InstanceEndEditable -->
...
<div id="titulo"><h1><strong>Dealers de Autos Nuevos</strong></h1></div><!--titulo-->
  <div id="titulo"><h2><strong>Venta Autos Nuevos, Toyota, Nissan, Kia, Hunday, Mazda, ford, chevrolet, Susuki, lexus, jeep, fiat, volswaguen, volvo, bmw, audi, alfa romeo, mini, cuper</strong></h2></div><!--titulo-->
<!-- InstanceEndEditable -->
 </div>
...
<?php
			$db = $cnx_slider;
			try{	
					$sql = $sql = "SELECT DISTINCT * FROM clientes WHERE (estatus= 'si') AND (id_serv =  'Dealers Autos Nuevos') ORDER BY pago='no' ASC";
