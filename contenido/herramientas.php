...
<html lang="en"><!-- InstanceBegin template="/Templates/contenido.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <!-- InstanceBeginEditable name="doctitle" -->
     <title>Venta de Herramientas de mecanica y hojalateria </title>
    <!-- InstanceEndEditable -->
    <!-- InstanceBeginEditable name="head" -->

    <meta name="description" content="Venta de herramientas de mecanica, Electromecanica y hojalateria para Autos, Camiones, vans y mas">
  <meta name="keywords" content=" Venta de herramientas de mecanica, Electromecanica y hojalateria para Autos, Camiones, vans telefono, direccion">
<!-- InstanceEndEditable -->
...
<!-- InstanceBeginEditable name="titulo" -->
 <div id="titulo"><h1><strong>Venta de Herramientas </strong></h1></div><!--titulo-->
  <div id="titulo"><h2><strong>Venta de Herramientas para mecanica, Electromecanica, hojalateros y mas</strong></h2></div><!--titulo-->
<!-- InstanceEndEditable -->
 </div>
...
<?php
			$db = $cnx_slider;
			try{	
					$sql = $sql = "SELECT DISTINCT * FROM clientes WHERE (estatus= 'si') AND (id_serv =  'Venta de Herramientas') ORDER BY pago='no' ASC";
