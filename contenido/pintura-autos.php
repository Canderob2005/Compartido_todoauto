...
<html lang="en"><!-- InstanceBegin template="/Templates/contenido.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <title>Pintura para autos, camiones, motoras</title>
    <!-- InstanceEndEditable -->
    <!-- InstanceBeginEditable name="head" -->
 <title>Centro pintura / pintura para autos, camiones, motoras</title>
    <meta name="description" content="Servicio y preparación de pintura para Autos, Camiones, motoras, vans, Autos nuevos, Autos usados">
  <meta name="keywords" content="Guia automotriz, busqueda de centros de  Pintura para autos, camiones, motoras en Puerto rico">
<!-- InstanceEndEditable -->
...
<!-- InstanceBeginEditable name="titulo" -->
 <div id="titulo"><h1><strong>Pintura para autos </strong></h1></div><!--titulo-->
  <div id="titulo"><h2><strong>Servicio y preparación de pintura para  Camiones, motoras, vans, Autos nuevos, Autos usados y mucho mas.</strong></h2></div>
<!-- InstanceEndEditable -->
 </div>
...
<?php
			$db = $cnx_slider;
			try{	
					$sql = $sql = "SELECT DISTINCT * FROM clientes WHERE (estatus= 'si') AND (id_serv =  'Centro pintura') ORDER BY pago='no' ASC";
