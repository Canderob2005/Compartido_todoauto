...
<html lang="en"><!-- InstanceBegin template="/Templates/contenido.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <title>Junkers en Pueto Rico</title>
    <!-- InstanceEndEditable -->
    <!-- InstanceBeginEditable name="head" -->

    <meta name="description" content="Piezas usadas para Autos y camiones y mucho mas">
  <meta name="keywords" content=" Piezas usadas para Autos y camiones, telefono, direccion">
<!-- InstanceEndEditable -->
...
<!-- InstanceBeginEditable name="titulo" -->
 <div id="titulo"><h1><strong>Venta Piezas Usadas Para Autos</strong></h1></div><!--titulo-->
  <div id="titulo"><h2><strong>Piezas usadas para Autos y camiones y mucho mas.</strong></h2></div><!--titulo-->
<!-- InstanceEndEditable -->
 </div>
...
<?php
			$db = $cnx_slider;
			try{	
					$sql = $sql = "SELECT DISTINCT * FROM clientes WHERE (estatus= 'si') AND (id_serv =  'Junkers') ORDER BY pago='no' ASC";
