...
<html lang="en"><!-- InstanceBegin template="/Templates/contenido.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <title>Asistencia en Carretera / Emergencias a todas horas / 24/7</title>
    <!-- InstanceEndEditable -->
    <!-- InstanceBeginEditable name="head" -->
 <meta name="description" content="Asistencia en Carretera / Emergencias a todas horas / 24/7 ,Servicio en Carretera">
  <meta name="keywords" content="Asistencia en Carretera / Emergencias a todas horas / 24/7, Servicio en Carretera, telefono, direccion">
<!-- InstanceEndEditable -->
...
<div id="titulo"><h1><strong>Asistencia en Carretera / Emergencias a todas horas / 24/7.</strong></h1></div><!--titulo-->
  <div id="titulo"><h2><strong>Servicio de grua, Gasolina, cambio de gomas, bateria, abrir autos y mucho mas.</strong></h2></div><!--titulo-->
<!-- InstanceEndEditable -->
 </div>
...
<?php
			$db = $cnx_slider;
			try{	
					$sql = $sql = "SELECT DISTINCT * FROM clientes WHERE (estatus= 'si') AND (id_serv =  'Servicio en Carretera, Asistencia en la Carretera') ORDER BY pago='no' ASC";
