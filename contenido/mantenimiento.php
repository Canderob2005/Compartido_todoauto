...
<html lang="en"><!-- InstanceBegin template="/Templates/contenido.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <title>Mantenimiento Autos y Camiones </title>
    <!-- InstanceEndEditable -->
    <!-- InstanceBeginEditable name="head" -->
 
    <meta name="description" content="Mantenimiento  Autos y camiones y mucho mas.">
  <meta name="keywords" content=" Busqueda de taller de Mantenimiento  Autos y camiones, telefono, direccion, taller"> 
<!-- InstanceEndEditable -->
...
<!-- InstanceBeginEditable name="titulo" -->
 <div id="titulo"><h1><strong>Mantenimiento</strong></h1></div><!--titulo-->
  <div id="titulo"><h2><strong>Mantenimiento para  Autos y camiones.</strong></h2></div><!--titulo-->
<!-- InstanceEndEditable -->
 </div>
...
<?php
			$db = $cnx_slider;
			try{	
					$sql = $sql = "SELECT DISTINCT * FROM clientes WHERE (estatus= 'si') AND (id_serv =  'Mantenimiento Autos') ORDER BY pago='no' ASC";
