...
<html lang="en"><!-- InstanceBegin template="/Templates/contenido.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <title>Alineamiento tren delantero para Autos, Camiones, mecanica liviana</title>
    <!-- InstanceEndEditable -->
    <!-- InstanceBeginEditable name="head" -->

    <meta name="description" content="Alineamiento tren delantero para Autos, Camiones, mecanica liviana">
  <meta name="keywords" content="Taller de Alineamiento para Autos,Camiones,mecanica,carros,tren delantero">
<!-- InstanceEndEditable -->
...
<div id="titulo"><h1><strong>Alineamiento tren delantero para autos, camiones, mecanica liviana</strong></h1></div><!--titulo-->
  <div id="titulo"><h2><strong>Alineamiento, ventas, piezas, instalación y reparación de tren delantero y mucho mas.</strong></h2
  ></div><!--titulo-->
<!-- InstanceEndEditable -->
 </div>
...
<?php
			$db = $cnx_slider;
			try{	
					$sql = $sql = "SELECT DISTINCT * FROM clientes WHERE (estatus= 'si') AND (id_serv =  'Alineamiento Para Autos') ORDER BY pago='no' ASC";
...
<!-- InstanceBeginEditable name="contenido" -->
 ...
 <!-- InstanceBeginEditable name="marquee" -->
   <div id="anuncio-footer"><MARQUEE WIDTH=100%  ALIGN=MIDDLE ><h5>Alineamiento instalación y reparación de tren delantero para Autos, vans,
   ventas piezas y mucho mas.....</h5></MARQUEE></div>
   <!-- InstanceEndEditable -->
 <!-- Footer -->
	<section  id="footer">
