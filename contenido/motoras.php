...
<html lang="en"><!-- InstanceBegin template="/Templates/contenido.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <title>Motoras Venta, Piezas Y servicio</title>
    <!-- InstanceEndEditable -->
    <!-- InstanceBeginEditable name="head" -->
 
    <meta name="description" content=" VENTA, PIEZAS Y SERVICIO PARA MOTORAS  DUCATI, HARLY DAVIDSON, KTM, BMW, TRIUMPH, VICTORIA, VENTO, HONDA, SUZUKI, YAMAHA, KAWASAKI,SEA DOO, POLARIS, CA AM y mucho mas.">
  <meta name="keywords" content="GUIA MOTORAS, VENTA PIEZAS Y SERVICIO PARA MOTORAS  DUCATI, HARLY DAVIDSON, KTM, BMW, TRIUMPH, VICTORIA, VENTO, HONDA, SUZUKI, YAMAHA, KAWASAKI,SEA DOO, POLARIS, CA AM y mucho mas.">
<!-- InstanceEndEditable -->
...
<!-- InstanceBeginEditable name="titulo" -->
 <div id="titulo"><h1><strong>Motoras Venta, Piezas y servicio</strong></h1></div><!--titulo-->
  <div id="titulo"><h2><strong>VENTA PIEZAS Y SERVICIO  MOTORAS  DUCATI, HARLY DAVIDSON, KTM, BMW, TRIUMPH, VICTORIA, VENTO, HONDA, SUZUKI, YAMAHA, KAWASAKI,SEA DOO, POLARIS, CA AM y mucho mas.</strong></h2></div><!--titulo-->
<!-- InstanceEndEditable -->
 </div>
...
<?php
			$db = $cnx_slider;
			try{	
					$sql = $sql = "SELECT DISTINCT * FROM clientes WHERE (estatus= 'si') AND (id_serv =  'Venta de Motoras') ORDER BY pago='no' ASC";
