...
<html lang="en"><!-- InstanceBegin template="/Templates/contenido.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
   ...
   <title>Auto parts, piezas para autos, respuestos para autos, originales, reemplazo, americanas, japonesas, koreanas, electricas, A Piezas para carros,tren delantero</title>
    <!-- InstanceEndEditable -->
    <!-- InstanceBeginEditable name="head" -->

    <meta name="description" content="Auto parts, Piezas para autos, Piezas para auto, Piezas americanas, Piezas japonesas, Piezas koreanas, Piezas electricas, Repuesto para autos, Piezas originales, Piezas nuevas para auto, Piezas para carros, Piezas  tren delantero para auto">
  <meta name="keywords" content=" Auto Parts. Telefono, Direccion">
<!-- InstanceEndEditable -->
...
$query_ms_slider = "SELECT * FROM sliderautoparts WHERE sliderautoparts.estado = 1 ORDER BY sliderautoparts.orden";
			...
			<?php do { ?>
			  <li>
				<a href="<?php echo $row_ms_slider['link']; ?>">
				  <img src="../banners-auto-parts/data1/images/<?php echo $row_ms_slider['imagen']; ?>" 
				 id="wows1_0"/>
				</a>
          </li>
...
<!-- InstanceBeginEditable name="titulo" -->
 ...
 <div id="titulo"><h1><strong>Auto Parts, Piezas para Auto, Piezas Americanas, Piezas Japonesas, Piezas  Koreanas, Piezas  Electricas, Repuesto para auto, </strong></h1></div><!--titulo-->
   
  <div id="titulo"><h1><strong> Piezas originales, Piezas nuevas para auto, Piezas para carros, Piezas  Tren delantero para auto, Piezas para sutos, y mucho mas.</strong></h1></div><!--titulo-->
<!-- InstanceEndEditable -->
 </div>
...
<?php
			$db = $cnx_slider;
			try{	
					$sql = $sql = "SELECT DISTINCT * FROM clientes WHERE (estatus= 'si') AND (id_serv =  'Auto parts') ORDER BY pago='no' ASC";
...
<!-- InstanceBeginEditable name="contenido" -->
 ...
 <!-- InstanceBeginEditable name="marquee" -->
   <div id="anuncio-footer"><MARQUEE WIDTH=100%  ALIGN=MIDDLE ><h5>Auto Parts, ventas  piezas nuevas para Autos, aceite, espares, shock absorber, frenos, pats, banda, filtro aceite y mucho mas.</h5></MARQUEE></div>
   <!-- InstanceEndEditable -->
 <!-- Footer -->
	<section  id="footer">
