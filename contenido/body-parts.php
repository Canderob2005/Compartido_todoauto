...
<html lang="en"><!-- InstanceBegin template="/Templates/contenido.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <title>Body parts / Venta Piezas carroceria Autos </title>
    <!-- InstanceEndEditable -->
    <!-- InstanceBeginEditable name="head" -->
 <meta name="description" content="Body parts,Piezas Nuevas, Venta Piezas carroceria Autos y mucho mas.">
  <meta name="keywords" content=" Body parts ,telefono, direccion, los mejores precios en piezas de carroceria americanas, Koreanas, Japonesas, chinas, europeas y mucho mas por pueblo.">
<!-- InstanceEndEditable -->
...
<!-- InstanceBeginEditable name="titulo" -->
 <div id="titulo"><h1><strong>Body parts / Venta piezas carroceria para autos </strong></h1></div><!--titulo-->
  <div id="titulo"><h2><strong>Aquí encontrara los mejores precios en piezas de carroceria americanas, Koreanas, Japonesas, chinas, europeas y mucho mas por pueblo.</strong></h2></div><!--titulo-->
<!-- InstanceEndEditable -->
 </div>
...
<?php
			$db = $cnx_slider;
			try{	
					$sql = $sql = "SELECT DISTINCT * FROM clientes WHERE (estatus= 'si') AND (id_serv =  'Body parts') ORDER BY pago='no' ASC";
