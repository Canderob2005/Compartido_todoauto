...
<html lang="en"><!-- InstanceBegin template="/Templates/contenido.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
   ...
   <title>Distribuidor piezas y respuestos</title>

    <!-- InstanceEndEditable -->
    <!-- InstanceBeginEditable name="head" -->
    <meta name="description" content="Distribuidor piezas para Autos, Camiones, vans, motoras">
  <meta name="keywords" content="Distribuidor piezas y respuestos para Autos, telefono, direccion">
<!-- InstanceEndEditable -->
...
<div id="titulo"><h1><strong>Distribuidor piezas y respuestos</strong></h1></div><!--titulo-->
  <div id="titulo"><h2><strong>Distribuidor piezas para Autos, Camiones, vans, motoras y mucho mas.</strong></h2></div><!--titulo-->
<!-- InstanceEndEditable -->
 </div>
...
<?php
			$db = $cnx_slider;
			try{	
					$sql = $sql = "SELECT DISTINCT * FROM clientes WHERE (estatus= 'si') AND (id_serv =  'Distribuidor') ORDER BY pago='no' ASC";
