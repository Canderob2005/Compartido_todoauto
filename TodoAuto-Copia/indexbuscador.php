 ...
 <div  class="col-sm-10"> 
  ...
  if ((! empty($_POST['id_serv'])) or (! empty($_POST['pueblo'])) ) {?>
      <table id="tabla"    class="table">
        <thead >
          <tr>
            <th><strong><p>Nombre</p></strong></th>
...
// Mostramos resultados de la busqueda
  ...
  ?>
          ...
          <td  style="width:33%;color:#0B0B61;"><strong><h5> <?php echo  "<a href=informacion-{$result[$key]['friendly_url']}.php>{$result[$key]['nombreNegocio']}</a><br>" ?></h5></strong></td>
