...
<html lang="en"><!-- InstanceBegin template="/Templates/contenido.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <meta name="description" content="Taller de reparación de motores para Autos, Camiones, mecanica">
  <meta name="keywords" content=" Servicios de Reparación de motores, telefono, direccion, taller,"> 
<!-- InstanceEndEditable -->
...
<!-- InstanceBeginEditable name="titulo" -->
  <div id="titulo"><h1><strong>Machine shop</strong></h1></div><!--titulo-->
  <div id="titulo"><h2><strong>Reparación de motores para Autos, Camiones, Vans y mucho mas.</strong></h2></div><!--titulo-->
<!-- InstanceEndEditable -->
 </div>
...
<?php
			$db = $cnx_slider;
			try{	
					$sql = $sql = "SELECT DISTINCT * FROM clientes WHERE (estatus= 'si') AND (id_serv =  'Machine shop') ORDER BY pago='no' ASC";
