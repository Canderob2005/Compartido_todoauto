...
<html lang="en"><!-- InstanceBegin template="/Templates/contenido.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <title>Prestamos para autos con titulo</title>
    <!-- InstanceEndEditable -->
    <!-- InstanceBeginEditable name="head" -->
 
    <meta name="description" content="Prestamos para Autos con titulo, vans">
  <meta name="keywords" content="Guia automotriz, servicios Prestamos para Autos con titulo, telefono, direccion">
<!-- InstanceEndEditable -->
...
<!-- InstanceBeginEditable name="titulo" -->
  <div id="titulo"><h1><strong>Prestamos para Autos</strong></h1></div><!--titulo-->
  <div id="titulo"><h2><strong>Prestamos para Autos con titulo y mucho mas.</strong></h2></div><!--titulo-->
<!-- InstanceEndEditable -->
 </div>
...
<?php
			$db = $cnx_slider;
			try{	
					$sql = $sql = "SELECT DISTINCT * FROM clientes WHERE (estatus= 'si') AND (id_serv =  'Prestamo Titulo') ORDER BY pago='no' ASC";
