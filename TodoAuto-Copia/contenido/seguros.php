...
<html lang="en"><!-- InstanceBegin template="/Templates/contenido.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <title>Seguros Para Autos</title>
    <!-- InstanceEndEditable -->
    <!-- InstanceBeginEditable name="head" -->

    <meta name="description" content="Seguros Para Autos, motoras, camiones, carros, Seguros Multiples, Velox24, cooperativa Seguros Multiples, universal insurance, ASC, QBE, multi national, mapfre, integrand, guardian, antilles, point guard, triple-s, triple s, sss y mucho mas.">
...
<!-- InstanceBeginEditable name="titulo" -->
 <div id="titulo"><h1><strong>Seguros Para Autos</strong></h1></div><!--titulo-->
  <div id="titulo"><H2><strong>Venta Seguros Para Autos, motoras, camiones, carros y mucho mas.</strong></H2></div><!--titulo-->
<!-- InstanceEndEditable -->
 </div>
...
<?php
			$db = $cnx_slider;
			try{	
					$sql = $sql = "SELECT DISTINCT * FROM clientes WHERE (estatus= 'si') AND (id_serv =  'Seguro de auto') ORDER BY pago='no' ASC";
