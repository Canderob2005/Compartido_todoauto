...
<html lang="en"><!-- InstanceBegin template="/Templates/contenido.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <meta name="description" content="Alquier de autos, vans de carga, vans de pasajero, camiones de carga, camiones refrigerados">
...
<!-- InstanceBeginEditable name="titulo" -->
 ...
 <div id="titulo"><h1><strong>Alquier autos, vans de carga, vans de pasajero, camiones de carga, camiones refrigerados</strong></h1></div><!--titulo-->
  <div id="titulo"><h2><strong>Los mejores precios y servicios en alquier de autos, vans de carga, vans de pasajero, camiones de carga, camiones refrigerados y mucho mas....</strong></h2></div><!--titulo-->
<!-- InstanceEndEditable -->
 </div>
...
<?php
			$db = $cnx_slider;
			try{	
					$sql = $sql = "SELECT DISTINCT * FROM clientes WHERE (estatus= 'si') AND (id_serv =  'Alquiler') ORDER BY pago='no' ASC";
