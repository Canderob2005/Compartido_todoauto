...
<html lang="en"><!-- InstanceBegin template="/Templates/contenido.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <title>Tapiceria para Autos</title>
    <!-- InstanceEndEditable -->
    <!-- InstanceBeginEditable name="head" -->

    <meta name="description" content="Tapiceria para Autos y camiones y mucho mas.<">
  <meta name="keywords" content="Guia automotriz, Busqueda de servicios Tapiceria, telefono, direccion, taller"> 
<!-- InstanceEndEditable -->
...
<!-- InstanceBeginEditable name="titulo" -->
 <div id="titulo"><h1><strong>Tapiceria Para Autos</strong></h1></div><!--titulo-->
  <div id="titulo"><h2><strong>Tapiceria para Autos y camiones y mucho mas.</strong></h2></div><!--titulo-->
<!-- InstanceEndEditable -->
 </div>
...
<?php
			$db = $cnx_slider;
			try{	
					$sql = $sql = "SELECT DISTINCT * FROM clientes WHERE (estatus= 'si') AND (id_serv =  'Tapiceria para autos') ORDER BY pago='no' ASC";
