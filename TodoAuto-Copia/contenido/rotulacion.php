...
<html lang="en"><!-- InstanceBegin template="/Templates/contenido.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <title>Rotulacion / Car design para camiones, Vans, Autos, Camiones, Autos nuevos, Autos usados </title>
    <!-- InstanceEndEditable -->
    <!-- InstanceBeginEditable name="head" -->

    <meta name="description" content="Rotulacion / Car design para camiones, Vans, Autos, Autos nuevos, Autos usados">
  <meta name="keywords" content="Guia automotriz, Busqueda servicios de Rotulacion / Car design para camiones, telefono, direccion,taller">
<!-- InstanceEndEditable -->
...
<!-- InstanceBeginEditable name="titulo" -->
 <div id="titulo"><h1><strong>Rotulacion / Car design</strong></h1></div><!--titulo-->
  <div id="titulo"><h2><strong>Car design, Rotulacion para camiones, Vans, Autos, Camiones, Autos y mucho mas.</strong></h2></div>
<!-- InstanceEndEditable -->
 </div>
...
<?php
			$db = $cnx_slider;
			try{	
					$sql = $sql = "SELECT DISTINCT * FROM clientes WHERE (estatus= 'si') AND (id_serv =  'Rotulación de autos') ORDER BY pago='no' ASC";
