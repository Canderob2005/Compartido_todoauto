...
<meta name="description" content="Taller Mecanica Camiones, Mecanica y reparación de Camiones desel, gaslina, gas y mucho mas.">
 <meta name="keywords" content="Taller, Mecanica Camiones, Servicio, Mecanica, reparación de Camiones desel, gaslina, gas y mucho mas, telefono, direccion"> 
<!-- InstanceEndEditable -->
...
<!-- InstanceBeginEditable name="titulo" -->
 <div id="titulo"><h1><strong>Taller Mecanica Camiones</strong></h1></div><!--titulo-->
  <div id="titulo"><h2><strong>Talleres de Mecanica y reparación de Camiones desel, gaslina, gas y mucho mas.</strong></h2></div><!--titulo-->
<!-- InstanceEndEditable -->
 </div>
