...
<html lang="en"><!-- InstanceBegin template="/Templates/contenido.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <title>Venta Reparación de Mangas Hidraulicas</title>
    <!-- InstanceEndEditable -->
    <!-- InstanceBeginEditable name="head" -->

    <meta name="description" content="Reparación de mangas hidraulica, manga, power steering para Autos y camiones y mucho mas.">
  <meta name="keywords" content=" Reparación de mangas hidraulica, telefono, direccion, taller">
<!-- InstanceEndEditable -->
...
<!-- InstanceBeginEditable name="titulo" -->
  <div id="titulo"><h1><strong>Venta Reparación de Mangas Hidraulicas</strong></h1></div><!--titulo-->
  <div id="titulo"><h2><strong>Reparación de mangas hidraulica, manga, power steering para Autos y camiones y mucho mas.</strong></h2></div>
<!-- InstanceEndEditable -->
 </div>
...
<?php
			$db = $cnx_slider;
			try{	
					$sql = $sql = "SELECT DISTINCT * FROM clientes WHERE (estatus= 'si') AND (id_serv =  'Mangas Hidraulicas') ORDER BY pago='no' ASC";
