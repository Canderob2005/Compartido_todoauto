...
<html lang="en"><!-- InstanceBegin template="/Templates/contenido.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <title>Los mejores Talleres de hojalateria y Pintura de Puerto rico</title>
    <!-- InstanceEndEditable -->
    <!-- InstanceBeginEditable name="head" -->

    <meta name="description" content="Taller de hojalateria y pintura para Autos y camiones de Puerto rico.">
  <meta name="keywords" content=" Taller de hojalateria y pintura , telefono, direccion">
<!-- InstanceEndEditable -->
...
<!-- InstanceBeginEditable name="titulo" -->
  <div id="titulo"><h1><strong>Los mejores Talleres de hojalateria y Pintura de Puerto rico, encúentralos aquí</strong></h1></div><!--titulo-->
  <div id="titulo"><h2><strong>Reparación carroceria y pintura para Autos y camiones.</strong></h2></div>
<!-- InstanceEndEditable -->
 </div>
...
<?php
			$db = $cnx_slider;
			try{	
					$sql = $sql = "SELECT DISTINCT * FROM clientes WHERE (estatus= 'si') AND (id_serv =  'Taller Hojalateria y pintura') ORDER BY pago='no' ASC";
