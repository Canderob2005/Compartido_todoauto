...
<html lang="en"><!-- InstanceBegin template="/Templates/contenido.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <title>Piezas Camiones</title>
    <!-- InstanceEndEditable -->
    <!-- InstanceBeginEditable name="head" -->

    <meta name="description" content="Venta piezas Camiones, Nuevas y Usadas para ford, chevrolet,mercedes benz,Dodge y mucho mas.">
  <meta name="keywords" content=" Venta piezas Camiones, telefono, direccion">
<!-- InstanceEndEditable -->
...
<!-- InstanceBeginEditable name="titulo" -->
  <div id="titulo"><h1><strong>Venta Piezas Camiones</strong></h1></div><!--titulo-->
  <div id="titulo"><h2><strong>Venta piezas camiones para ford, chevrolet,mercedes benz,Dodge y mucho mas.</strong></h2></div><!--titulo-->
<!-- InstanceEndEditable -->
 </div>
...
<?php
			$db = $cnx_slider;
			try{	
					$sql = $sql = "SELECT DISTINCT * FROM clientes WHERE (estatus= 'si') AND (id_serv =  'Piezas de Camiones') ORDER BY pago='no' ASC";
