...
<html lang="en"><!-- InstanceBegin template="/Templates/contenido.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
   ...
   <title>Detailing / Lavado Auto</title>
    <!-- InstanceEndEditable -->
    <!-- InstanceBeginEditable name="head" -->
 
    <meta name="description" content="Limpiesa para Autos y camiones, van, guaguas pasajeros y mucho mas">
  <meta name="keywords" content="Limpiesa para Autos, telefono, direccion">
<!-- InstanceEndEditable -->
...
<div id="titulo"><h1><strong> Limpieza Autos Detailing</strong></h1></div><!--titulo-->
  <div id="titulo"><h2><strong>Limpiesa para Autos y camiones, van, guaguas pasajeros y mucho mas.</strong></h2></div><!--titulo-->
<!-- InstanceEndEditable -->
 </div>
...
<?php
			$db = $cnx_slider;
			try{	
					$sql = $sql = "SELECT DISTINCT * FROM clientes WHERE (estatus= 'si') AND (id_serv =  'Lavado autos, Detailing') ORDER BY pago='no' ASC";
