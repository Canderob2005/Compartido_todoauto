...
<html lang="en"><!-- InstanceBegin template="/Templates/contenido.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <title>taller de mecanica automotriz en Puerto rico</title>
    <!-- InstanceEndEditable -->
    <!-- InstanceBeginEditable name="head" -->
 
    <meta name="description" content="Taller de mecanica automotriz en Puerto rico.">
  <meta name="keywords" content="  Taller de mecanica para Autos en Puerto rico, telefono, direccion, por especialidad">
<!-- InstanceEndEditable -->
...
<!-- InstanceBeginEditable name="titulo" -->
  <div id="titulo"><h1><strong>Taller de mecanica automotriz en Puerto rico.</strong></h1></div><!--titulo-->
  <div id="titulo"><h2><strong>Los mejores precios y servicios en  mecanica automotriz en Puerto rico , encúentralos aquí</strong></h2></div><!--titulo--><!--titulo-->
<!-- InstanceEndEditable -->
 </div>
...
<?php
			$db = $cnx_slider;
			try{	
					$sql = $sql = "SELECT DISTINCT * FROM clientes WHERE (estatus= 'si') AND (id_serv =  'Taller Mecanica Autos') ORDER BY pago='no' ASC";
