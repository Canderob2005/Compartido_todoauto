...
<html lang="en"><!-- InstanceBegin template="/Templates/contenido.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <title>Tinte Glass,Tinte para autos, cristales ahumados para  Auto y camiones </title>
    <!-- InstanceEndEditable -->
    <!-- InstanceBeginEditable name="head" -->
 
    <meta name="description" content="Tinte para autos, Tinte Glass, cristales ahumados para camiones, Vans, Autos, Autos nuevos, Autos usados">
...
<!-- InstanceBeginEditable name="titulo" -->
  <div id="titulo"><h1><strong>Tinte Glass </strong></h1></div><!--titulo-->
  <div id="titulo"><h2><strong>Tinte Glass, Tinte para autos, cristales ahumados para camiones, Vans, Autos nuevos y usados y mucho mas.</strong></h2></div>
<!-- InstanceEndEditable -->
 </div>
...
<?php
			$db = $cnx_slider;
			try{	
					$sql = $sql = "SELECT DISTINCT * FROM clientes WHERE (estatus= 'si') AND (id_serv =  'Tinte para autos') ORDER BY pago='no' ASC";
