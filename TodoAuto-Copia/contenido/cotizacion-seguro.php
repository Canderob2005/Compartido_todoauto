...
<br>
  <div id="titulo"><h1><strong>Cotización de seguro computarizado</strong></h1></div><!--titulo-->
  <div id="titulo"><h2><strong>Cotización de seguro computarizado para autos y mucho mas</strong></h2></div><!--titulo-->
<!-- InstanceEndEditable -->
 </div>
