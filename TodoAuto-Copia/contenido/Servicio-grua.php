...
<html lang="en"><!-- InstanceBegin template="/Templates/contenido.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <title>Servicio de grua / Remolque para Autos</title>
    <!-- InstanceEndEditable -->
    <!-- InstanceBeginEditable name="head" -->
<title>Grua / Remolque</title>
    <meta name="description" content="Remolque para Autos y camiones y mucho mas.">
...
<!-- InstanceBeginEditable name="titulo" -->
 <div id="titulo"><h1><strong>Servicio de Grua  </strong></h1></div><!--titulo-->
  <div id="titulo"><h2><strong>Remolque para Autos y camiones y mucho mas.</strong></h2></div><!--titulo-->
<!-- InstanceEndEditable -->
 </div>
...
<?php
			$db = $cnx_slider;
			try{	
					$sql = $sql = "SELECT DISTINCT * FROM clientes WHERE (estatus= 'si') AND (id_serv =  'Servicio de grua') ORDER BY pago='no' ASC";
