...
<html lang="en"><!-- InstanceBegin template="/Templates/contenido.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <title>Los mejores taller de Aire acondicionado para Autos del 2020</title>
    <!-- InstanceEndEditable -->
    <!-- InstanceBeginEditable name="head" -->
<meta name="description" content="Los mejores taller de Aire acondicionado autos , camiones ,ventas instalación, reparación de aire automotriz, piezas, condensador, compresor, valvula, gas,frion,Venta,Reparación  Aire Acondicionado,aire acondicionado , autos o carros">
<meta name="keywords" content="Aire acondicionado autos,Venta,Reparación, Aire Acondicionado, piezas,ventas instalación y reparación de aire automotriz,condensador, compresor,valvula,gas,frion, aire acondicionado">
<!-- InstanceEndEditable -->
...
<!-- InstanceBeginEditable name="titulo" -->
 ...
 <div id="titulo"><h1><strong>Los mejores taller de Aire acondicionado para Autos del 2020</strong></h1></div><!--titulo-->
  <div id="titulo"><h2><strong>Ventas, instalación, reparación de aire para auto y camiones</strong></h2></div><!--titulo-->
<!-- InstanceEndEditable -->
 </div>
...
<?php
			$db = $cnx_slider;
			try{	
					$sql = $sql = "SELECT DISTINCT * FROM clientes WHERE (estatus= 'si') AND (id_serv =  'Aire autos') ORDER BY pago='no' ASC";
