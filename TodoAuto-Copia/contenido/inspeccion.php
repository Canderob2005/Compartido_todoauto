...
<html lang="en"><!-- InstanceBegin template="/Templates/contenido.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <title>Centro de Inspección / Venta de Marbete</title>
    <!-- InstanceEndEditable -->
    <!-- InstanceBeginEditable name="head" -->

    <meta name="description" content="Centro de inspección y venta de marbete.">
  <meta name="keywords" content=" Centros de inspección para Autos y venta de marbete, telefono, direccion, taller">
<!-- InstanceEndEditable -->
...
<!-- InstanceBeginEditable name="titulo" -->
 <div id="titulo"><h1><strong>Centro de inspección y venta de marbete</strong></h1></div><!--titulo-->
  <div id="titulo"><h2><strong>Centros de inspección para Autos y Venta de marbete.</strong></h2></div><!--titulo-->
<!-- InstanceEndEditable -->
 </div>
...
<?php
			$db = $cnx_slider;
			try{	
					$sql = $sql = "SELECT DISTINCT * FROM clientes WHERE (estatus= 'si') AND (id_serv =  'Centro de Inspección autos') ORDER BY pago='no' ASC";
