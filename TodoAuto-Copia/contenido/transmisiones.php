...
<html lang="en"><!-- InstanceBegin template="/Templates/contenido.dwt.php" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <title>Taller reparación de Transmisiones automaticas</title>
    <!-- InstanceEndEditable -->
    <!-- InstanceBeginEditable name="head" -->
 
    <meta name="description" content="Reparación de Transmisiones Automaticas, camiones y mucho mas.">
  <meta name="keywords" content="Guia automotriz, Busqueda de servicios de Reparación de Transmisiones Automaticas , telefono, direccion, taller, especialidad">
<!-- InstanceEndEditable -->
...
<!-- InstanceBeginEditable name="titulo" -->
 <div id="titulo"><h1><strong>Reparación de Transmisiones automaticas</strong></h1></div><!--titulo-->
  <div id="titulo"><h2><strong>Reparación de Transmisiones automaticas para Autos / camiones y mucho mas.</strong></h2></div>
<!-- InstanceEndEditable -->
 </div>
...
<?php
			$db = $cnx_slider;
			try{	
					$sql = $sql = "SELECT DISTINCT * FROM clientes WHERE (estatus= 'si') AND (id_serv =  'Transmisiones automaticas') ORDER BY pago='no' ASC";
