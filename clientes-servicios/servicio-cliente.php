...
<meta name="description" content="Servicio al cliente, Corregir anuncio, Facturación, Anuncio no autorizado" />
...
?>
	...
	<div id="cabecera">
    <h2 style="text-align:center; margin-top:-2PX;">Servicio al cliente</h2>
            </div>
	<!-- InstanceEndEditable -->
  ...
  <div id="contenedor">
    <div id="titulo"><h1 style="text-align:center;">Departamento de servicio al cliente</h1></div>
     <div id="titulo"><h2> Favor de escoger servicio deseado</h2></div>

    <div id="card">
    
   <div class="card ">
  <div class="card-body">
    <h4 class="card-title">Corregir Anuncio</h4>
    <p class="card-text">Ingrese su información.</p>
    <a  href="correccion-anuncio.php" class="btn btn-primary stretched-link ">Para Comenzar Click Aqui</a>
  </div>
</div>
  ...
  <div class="card-body">
    ...
    <p class="card-text">Reclamaciones.</p>
     <a href="reclamo-factura.php" class="btn btn-primary stretched-link">Para Comenzar Click Aqui</a>
    ...
    <div class="card">
  <div class="card-body">
    <h4 class="card-title">Anuncio no autorizado</h4>
    <p class="card-text">Información.</p>
    <a href="anuncio-no-autorizado.php" class="btn btn-primary stretched-link">Para Comenzar Click Aqui</a>
  </div>
</div>
...
<!-- InstanceBeginEditable name="marquee" -->
 <div id="anuncio-footer"><MARQUEE WIDTH=100%  ALIGN=MIDDLE ><h5>Servicio al cliente, Corregir anuncio, Facturación, Anuncio no autorizado y mucho mas.....</h5></MARQUEE></div>
 <!-- InstanceEndEditable -->
 <!-- Footer -->
	<section  id="footer">
