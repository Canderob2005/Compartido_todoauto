...
<title>Registro Clientes Medium</title>
<meta name="description" content="Pagina de Registro Clientes Medium, servicios automotriz, telefono de negocio, direccion de negocios,taller por especialidad, Dealers, seguros, centro de inspeccion,compañias de prestamos de auto, financiamiento de autos">
...
<body>
    ...
    <nav  class="navbar navbar-expand-md ">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        ...
        <a class="nav-link" href="../indexbuscador.php" title="Buscador">Buscador</a>
          ...
          <li class="nav-item active">
        <a class="nav-link" href="../clientes-servicios/intro-clientes.php">Anunciate</a>
        </li>
          <li class="nav-item active">
            <a class="nav-link" href="menu.php" title="Menu">Menu</a>
          </li>   
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" data-toggle="modal" data-target="#contactanosModal" href="#">Contactanos</a>
        </div>
      </li>
      <li class="nav-item">
 ...
 <div id="cabecera">
			  ...
			  <h2 style="text-align:center; margin-top:-2PX;">REGISTRO CLIENTES MEDIUM</h2>
            </div>
