...
.radio-inline {
	...
	margin-right:20px;
		...
		<div class="container">
			<div class="row">
            <div id="cabecera">
            <div id="logo"><a href="../index.php"><img src="img-logo/todo-auto-pr.png"  alt="todo auto"></a></div>
...
<table width="100%" border="0">
  ...
  <tr>
    ...
    <td><label class="checkbox-inline">
     ...
     <td><label class="checkbox-inline">
							<input type="checkbox" id="intereses[]" name="intereses[]" value="Luces decorativas"> Marbete
						</label></td>                    
  </tr>
  </table>
   <br />
