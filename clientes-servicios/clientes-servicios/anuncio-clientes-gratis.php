...
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/formulario-premium.dwt.php" codeOutsideHTMLIsLocked="false" -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="viewport" content="width=device-width, initial-scale=1">
<!-- InstanceBeginEditable name="doctitle" -->
<title>REGISTRO CLIENTES GRATIS</title>
<meta name="description" content="REGISTRO CLIENTES GRATIS pera servicios automotriz, telefono de negocio,  direccion de negocios, Nombre taller por especialidad, Nombre de Dealers, compañias de seguros, Taller de centro de inspeccion, Nombre de compañias de prestamos de auto,Compañias de financiamiento de autos" />
  
<meta name="keywords" content="REGISTRO CLIENTES GRATIS para Servicios para Autos, Camiones, motoras, mecanica, Hojalatero, Electromecanico ,Dealesr , seguro, Alquiler, Radiadores, Body part, Detailing , Aros, Marbete, inspeccion, Autos nuevos, Autos usados, Junkers, Piezas,Piezas nuevas,piezas usadas,Financiamiento, prestamos, Gruas, Gomas &amp;,Distribuidores, Accesorios " />  
<!-- InstanceEndEditable -->
    ...
    <nav  class="navbar navbar-expand-md ">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        ...
        <a class="nav-link" href="../../indexbuscador.php" title="Buscador"><i class="fa fa-fw fa-search"></i>Buscador</a>
          ...
          <li class="nav-item active">
        <a class="nav-link" href="intro-clientes.php"><i class="fa fa-refresh fa-spin fa-1x fa-fw"></i>
...
Menu</a>
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item"  href="intro-clientes.php">Anunciate</a>
...
<!-- InstanceBeginEditable name="titulo" -->
 <h2 style="text-align:center; margin-top:-2PX;">Registro clientes gratis</h2>
<!-- InstanceEndEditable -->
...
<div id="contenedor3">          
			...
			<h2 style="text-align:center; margin-top:-2PX;">Favor de leer y llenar cuidadosamente cada sección</h2>
...
<td><label class="checkbox-inline">
    ...
    <td><label class="checkbox-inline">
        ...
        <option value="Piezas Camiones ">Piezas Camiones </option>                            
 ...
 <tr align="center">                                           
  ...
  <tr align="center">
    ...
    <td ><label class="checkbox-inline">
							<input type="checkbox" id="intereses[]" name="intereses[]" value=" Vans "> Vans 
						</label></td>
...
<table style="margin-left:1%;" width="100%" border="0">
 ...
 <div hidden class="form-group">
					...
					<div class="col-sm-10">
                    <input type="file" id="files" name="archivo"  onchange='cambiar()' />
						
<div id="info"><img src="../files/no-foto/no-photo-camara.jpg" /></div>
<script>
           function cambiar(){
    var pdrs = document.getElementById('files').files[0].name;
