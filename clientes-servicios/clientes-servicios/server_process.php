<?php
	...
	*/
	...
	$aColumnas = array( 'id', 'estatus' ,'nombreCliente',  'nombreNegocio', 'pago' ,'metodoPago','tipoAnuncio', 'id_serv' , 'email', 'telefonoCliente' ,'telefonoNegocio' , 'direccionNegocio' , 'pueblo' , 'serv_dom'  , 'intereses');
