...
<title>Departamento  Facturación</title>
<meta name="description" content="Departamento  Facturación, Corrección de Banners, Corrección de posicionamiento, Corrección de Auncios, Corrección de Poo-up, Corrección de informacion y mucho mas" />
<meta name="keywords" content="Departamento  Facturación" /> 
<!-- InstanceEndEditable -->
<!-- Bootstrap CSS -->
...
?>
	...
	<div id="cabecera">
    <h2 style="text-align:center; margin-top:-2PX;">Departamento  Facturación</h2>
            </div>
	<!-- InstanceEndEditable -->
 ...
 <div id="contenedor"> 
<div id="titulo"><h1 style="color:#F00; margin-left:10px;">Para verificar su factura</h1></div>
     <div id="titulo"><h2 style="color:#F00; margin-left:10px;">Favor de escoger tipo de cominicación</h2></div>
      ...
      <div id="titulo"><h2 style="color:#00F; margin-left:10px;"> Numero de Cliente.</h2></div>
