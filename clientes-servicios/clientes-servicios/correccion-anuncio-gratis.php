...
<title>Departamento Corrección de Anuncio</title>
 ...
 <header>
   <div id="menu">
    ...
    <nav  class="navbar navbar-expand-md ">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        ...
        <a class="nav-link" href="intro-clientes.php">Anunciate</a>
         ...
         <li class="nav-item active">
        <a class="nav-link" href="servicio-cliente.php">Servicio</a>
        </li>
    ...
    <div id="cabecera">
			  ...
			  <h2 style="text-align:center; margin-top:-2PX;">Departamento  Corrección de Anuncio Gratis</h2>
            </div>
 </header> 
  <div id="contenedor">
