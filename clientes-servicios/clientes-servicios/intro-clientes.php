...
<title>Opciones Anuncio</title>
<meta name="description" content="Opciones Anuncio, Crear Banners, posicionamiento, Auncios, Poo-up, informacion y mucho mas" />
<meta name="keywords" content="Opciones Anuncio" /> 
<!-- InstanceEndEditable -->
<!-- Bootstrap CSS -->
...
?>
	...
	<div id="cabecera">
    <h2 style="text-align:center; margin-top:-2PX;">Opciones Anuncio</h2>
            </div>
	<!-- InstanceEndEditable -->
 ...
 <div id="contenedor">
    <div id="titulo"><h1 style="color:#F00; margin-left:10px;">Anunciate Aqui.....</h1></div>
     <div id="titulo"><h2 style="color:#F00; margin-left:10px;">Favor de escoger una opción para promocionar su negocio</h2></div>
  ...
  <div class="card-body">
    ...
    <a href="anuncio-clientes-gratis.php" class="btn btn-primary stretched-link">Para Comenzar Click Aqui</a>
  </div>
</div>
    ...
    <div class="card">
  <div class="card-body">
    <h4 class="card-title">Anuncio Premium</h4>
    <p class="card-text">Ingrese su información.</p>
