...
<title>Departamento Correción de Anuncio Pago</title>
<meta name="description" content="Departamento Corrección de Anuncio Pago, Corrección de Banners, Corrección de posicionamiento, Corrección de Auncios, Corrección de Poo-up, Corrección de informacion y mucho mas" />
<meta name="keywords" content="Departamento Correción de Anuncio" /> 
<!-- InstanceEndEditable -->
<!-- Bootstrap CSS -->
...
?>
	...
	<div id="cabecera">
    <h2 style="text-align:center; margin-top:-2PX;">Departamento Correción de Anuncio</h2>
            </div>
	<!-- InstanceEndEditable -->
 ...
 <div id="contenedor">
    <div id="titulo"><h1 style="color:#F00; margin-left:10px;">Para corregir anuncio</h1></div>
     <div id="titulo"><h2 style="color:#F00; margin-left:10px;">Favor de escoger tipo anuncio</h2></div>

    <div id="card">
    
   <div class="card">
  <div class="card-body">
    <h4 class="card-title">Anuncio Gratis</h4>
    ...
    <div class="card">
  <div class="card-body">
    <h4 class="card-title">Anuncio Pago</h4>
    <p class="card-text">Ingrese su información.</p>
    <a href="anuncio-cliente-premium.php" class="btn btn-primary stretched-link">Para Comenzar Click Aqui</a>
  </div>
</div>
</div>
