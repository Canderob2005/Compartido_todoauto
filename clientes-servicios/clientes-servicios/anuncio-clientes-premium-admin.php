...
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/formulario-premium-ADMIN.dwt.php" codeOutsideHTMLIsLocked="false" -->
<head>
...
Menu</a>
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="servicio-cliente.php">Servicio</a>
...
<!-- InstanceBeginEditable name="titulo" -->
 <h2 style="text-align:center; margin-top:-2PX;">REGISTRO CLIENTES PREMIUM ADMIN</h2>
<!-- InstanceEndEditable -->
...
<td><label class="checkbox-inline">
   ...
   <hr / style="color:rgb(0,0,255); border:solid 3px; width:100%;">
                ...
                <label class="checkbox-inline" style="margin-left:15%;">
