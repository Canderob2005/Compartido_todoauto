...
<title>form arreglado</title>
</head>

<body>
<h1>Form arreglado</h1>
...
<div class="container">
			...
			<form class="form-horizontal" method="POST" action="guardar2.php" autocomplete="off">
                ...
                <div class="form-group">
					<label for="nombre-negocio" class="col-sm-2 control-label">Nombre</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" id="nombre" name="nombre" placeholder="Nombre del negocio" required>
					</div>
				</div>
					...
					<div class="col-sm-10">
						<label class="radio-inline">
							<input type="radio" id="pago" name="pago" value="si"> SI
						</label>
...
<option value="Tapiceria para autos">Tapiceria para autos</option>
	...
	<option value="Transmisiones automaticas" >Transmisiones automaticas</option>
                ...
                <div class="form-group">
					...
					<div class="col-sm-10">
						<input type="tel" class="form-control" id="numero" name="numero" placeholder="Telefono Negocio">
					</div>
				</div>
                
                <div class="form-group">
					<label for="dirreccion" class="col-sm-2 control-label">Dirreccion Negocio</label>
					<div class="col-sm-10">
		<input type="text" class="form-control" id="dirreccion" name="dirreccion" placeholder="Dirrección Negocio" >
					</div>
				</div>
                ...
                <br />
					...
					<div  class="col-sm-10">
                       ...
                       <h4>Selección de Autos/Camiones venta O Servicios especializados </h4>
                       <label class="checkbox-inline">
							<input type="checkbox" id="intereses[]" name="intereses[]" value="Venta de">Venta de
						</label>
                        <br />
                        <label class="checkbox-inline">
							<input type="checkbox" id="intereses[]" name="intereses[]" value="servicio a">Servicio especializados
						</label>
                        <br />
                        <hr / style="color:rgb(0,0,255); border:solid 3px;">
