...
<title>Anuncio no autorizado</title>
<meta name="description" content="Anuncio no autorizado, Corrección de Banners,Corrección de Auncios, Corrección de Poo-up, Corrección de informacion y mucho mas" />
<meta name="keywords" content="Anuncio no autorizado" /> 
<!-- InstanceEndEditable -->
<!-- Bootstrap CSS -->
...
?>
	...
	<div id="cabecera">
    <h2 style="text-align:center; margin-top:-2PX;">Anuncios no autorizado</h2>
            </div>
	<!-- InstanceEndEditable -->
 ...
 <div id="contenedor"> 
<div id="titulo"><h1 style="color:#F00; margin-left:10px;">Para verificar el anuncio</h1></div>
     <div id="titulo"><h2 style="color:#F00; margin-left:10px;">Favor de escoger tipo de cominicación</h2></div>
      ...
      <div id="titulo"><h2 style="color:#00F; margin-left:10px;"> Numero del anuncio.</h2></div>
