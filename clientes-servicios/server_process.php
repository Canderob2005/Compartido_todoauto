<?php
	...
	$aColumnas = array( 'id', 'estatus' ,'metodoPago','tipoAnuncio','nombreCliente',  'nombreNegocio', 'pago' , 'id_serv' , 'email', 'telefonoCliente' ,'telefonoNegocio' , 'direccionNegocio' , 'pueblo' , 'serv_dom'  , 'entrega_dom'  , 'intereses');
