...
.radio-inline {
  ...
  <tr>
    ...
    <td><label class="checkbox-inline">
                ...
                <option value="Bayamón" <?php if($row['pueblo']=='Bayamón') echo 'selected'; ?>>Bayamón</option>
   ...
   <hr / style="color:rgb(0,0,255); border:solid 3px; width:100%;">                
        ...
        <option value="Centro pintura para autos" <?php if($row['id_serv']=='Centro pintura para autos') echo 'selected'; ?>>Centro pintura para autos</option> 
