...
<title>Departamento de Promociones</title>
<meta name="description" content="Departamento de Promociones,Crear Banners, posicionamiento, Auncios, Poo-up, informacion y mucho mas">
<meta name="keywords" content="Departamento de Promociones"> 
<!-- TemplateEndEditable -->
<!-- Bootstrap CSS -->
...
?>
	...
	<div id="cabecera">
    <h2 style="text-align:center; margin-top:-2PX;">Departamento de promociones</h2>
            </div>
	<!-- TemplateEndEditable -->
     
  </header> 
  <!-- TemplateBeginEditable name="contenedor" -->
 <div id="contenedor"> 
   ...
   <div class="card ">
  <div class="card-body">
    <h4 class="card-title">Publicidad Basica </h4>
    <p class="card-text">Detalles.</p>
    <a href="publicidad-basica.php" class="btn btn-primary stretched-link">Para información Click Aqui</a>
  </div>
</div>
    ...
    <div class="card">
  <div class="card-body">
    <h4 class="card-title">Publicidad Mediana</h4>
    <p class="card-text">Detalles.</p>
    <a href="publicidad-mediana.php" class="btn btn-primary stretched-link">Para información Click Aqui</a>
  </div>
</div>
    ...
    <div class="card">
  <div class="card-body">
    <h4 class="card-title">Publicidad Pro</h4>
    <p class="card-text">Detalles.</p>
    <a href="publicidad-pro.php" class="btn btn-primary stretched-link">Para información Click Aqui</a>
  </div>
</div>
  </div>  
</div> 
...
<!---------------------Banner--------------------------------->
<!-- TemplateBeginEditable name="marquee" -->
