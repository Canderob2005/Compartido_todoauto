...
<title>REGISTRO CLIENTES PREMIUM</title>
<meta name="description" content="REGISTRO CLIENTES PREMIUM pera servicios automotriz, telefono de negocio,  direccion de negocios, Nombre taller por especialidad, Nombre de Dealers, compañias de seguros, Taller de centro de inspeccion, Nombre de compañias de prestamos de auto,Compañias de financiamiento de autos">
  
<meta name="keywords" content="REGISTRO CLIENTES PREMIUM para Servicios para Autos, Camiones, motoras, mecanica, Hojalatero, Electromecanico ,Dealesr , seguro, Alquiler, Radiadores, Body part, Detailing , Aros, Marbete, inspeccion, Autos nuevos, Autos usados, Junkers, Piezas,Piezas nuevas,piezas usadas,Financiamiento, prestamos, Gruas, Gomas &,Distribuidores, Accesorios ">  
<!-- TemplateEndEditable -->
<link href="../dist/css/bootstrap.min.css" rel="stylesheet">
<link rel="stylesheet" type="text/css" href="../clientes-servicios/css/clientes-servicios.css"/>
<link rel="stylesheet" type="text/css" href="../css/principal.css"/>
<link rel="shortcut icon" href="../clientes-servicios/todoautopr.ico" />
...
<header>
 <div id="menu">
    ...
    <nav  class="navbar navbar-expand-md ">
      <a class="navbar-brand img-responsive" href="../index.php"><img src="../clientes-servicios/img-logo/todo-auto-pr.png"  alt="Todo Auto PR" /></a>
...
<div id="contenedor3">          
			...
			<h2 style="text-align:center; margin-top:-2PX;">Registro Clientes</h2>
              
            </div>
			
			 <form class="form-horizontal" method="POST" action="../clientes-servicios/guardar.php" enctype="multipart/form-data" autocomplete="">
              ...
              document.getElementById('files').addEventListener('change', archivo, false);
				...
				<div class="form-group">
					<div class="col-sm-offset-2 col-sm-10">
						<a href="../clientes-servicios/intro-clientes.php" class="btn btn-danger" style=" float:left;">Regresar</a>
