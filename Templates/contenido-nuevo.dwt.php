...
<link rel="shortcut icon" href="../contenido/todoautopr.ico"/>
...
<body>
  ...
  <header>
    ...
    <nav  class="navbar navbar-expand-md ">
      <a class="navbar-brand img-responsive" href="../contenido/index.php"><img src="../img-logo/todo-auto-pr.png"  alt="Todo Auto PR" /></a>
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav mr-auto">
         <li class="nav-item active">
            <a class="nav-link" href="../contenido/index.php"><i class="fa fa-fw fa-home"></i>Home <span class="sr-only">(current)</span></a>
          </li>
        <li class="nav-item active">
        <a class="nav-link" href="../contenido/indexbuscador.php" title="Buscador"><i class="fa fa-fw fa-search"></i>Buscador</a>
        </li>
          <li class="nav-item active">
        <a class="nav-link" href="../contenido/clientes-servicios/intro-clientes.php"><i class="fa fa-refresh fa-spin fa-1x fa-fw"></i>
...
Registrate</a>
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item"  href="../contenido/clientes-servicios/intro-clientes.php">Anunciate</a>
          <a class="dropdown-item" href="../contenido/clientes-servicios/servicio-cliente.php">Servicios</a>
          <a class="dropdown-item" href="../contenido/contenido/quienes-somos.php">Quienes Somos</a>
           <a class="dropdown-item" href="../contenido/contenido/sugerencias.php">Tips y Sugerencias</a>
         </div>
...
?>
	...
	<div class="ws_images">
		<ul>
			<?php do { ?>
			  <li>
				<a href="<?php echo $row_ms_slider['../contenido/link']; ?>">
...
$sql = "SELECT DISTINCT * FROM clientes WHERE (estatus= 'si') AND (id_serv =  'Accesorios') ORDER BY pago='no' ASC";
...
<div class="card-body">
 ...
 <a href="..informacion/<?php echo $record['friendly_url']; ?>"> 
...
<script type="text/javascript" src="../contenido/slide-mysql/engine1/wowslider.js"></script>
