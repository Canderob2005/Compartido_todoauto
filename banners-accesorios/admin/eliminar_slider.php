...
if ((isset($_GET['recordID'])) && ($_GET['recordID'] != "")) {
  $deleteSQL = sprintf("DELETE FROM accesorios WHERE id_slider=%s",
                       GetSQLValueString($_GET['recordID'], "int"));

  mysqli_select_db($cnx_slider,$database_cnx_slider );
  $Result1 = mysqli_query( $cnx_slider,$deleteSQL) or die(mysqli_error());
...
<html lang="es">
  <head>
    ...
    <title>Eliminar Banners Accesorios</title>
    <!-- Bootstrap -->
