...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE accesorios SET titulo=%s, imagen=%s, noticia=%s, link=%s, orden=%s, estado=%s WHERE id_slider=%s",
...
$query_edit_slider = sprintf("SELECT * FROM accesorios WHERE accesorios.id_slider = %s", $varDato_edit_slider);
...
<html lang="es">
  <head>
    ...
    <title>Editar Banners Accesorios</title>
    <!-- Bootstrap -->
