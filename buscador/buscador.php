...
<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    ...
    <title>Todo Auto Pr / Todo Auto </title>   
  ...
  <header>
    ...
    <nav  class="navbar navbar-expand-md ">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        ...
        <li class="nav-item active">
        <a class="nav-link" href="buscador/buscador.php" title="Buscador"><i class="fa fa-fw fa-search"></i>Buscador</a>
        </li>
          <li class="nav-item active">
...
?>
  ...
  <div id="contenedor"> 
 <div id="titulo">
   <h1 style="color:#0B0B61;" >¿Buscas un servicio automotriz? ¿Piezas para tu auto? ¿Un auto nuevo o usado?</h1>
  <h2 style="color:#0B0B61;" >Llegaste el lugar indicado, aqui encuentra autos nuevos / usados , camiones, motoras, auto parts, body parts, hojalateria, mecanica, electromecanica, inspección, marbete y mucho mas para tu auto</h2>
  ...
  <div class="row">
    <div class="col-xs-12 col-md-12">
      <div class="form-group">
        ...
        <select  class="form-control" id="servicio"  name="id_serv">
            <?php genera_select("id_serv");?>
            </select>
           <select  class="form-control"  id="pueblo" name="pueblo">
          </select>
          <button class="btn-primary">
           <input  class="form-control" id="enviar" type="submit" value="Buscar"/>
           </button>
           </form>
        </div>
      </div>
...
<link rel='stylesheet' href='https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.1.3/css/bootstrap.min.css'>
 ...
 <!--fin css banners -->
 <link rel="stylesheet" type="text/css" href="../css/style-contenido.css"/>
 ...
 <!-- fin js banners -->
 <script type="text/javascript" src="./js/ddba1ed91f.js"></script>
 <script type="text/javascript" src="./slide-mysql/bootstrap/js/jquery.min.js"></script>
    <script src="./js/bootstrap.min.js"></script>
    <script type="text/javascript" src="./js/jquery-latest.js"></script>
    <script type="text/javascript" src="./js/ir-arriba.js"></script>
 	<script type="text/javascript" src="./js/letras-animate.js"></script>
